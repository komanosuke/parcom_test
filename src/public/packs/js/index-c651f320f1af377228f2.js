...
/* WEBPACK VAR INJECTION */(function($) {console.log('ok');
...
function graph() {
  ...
  var $score = document.getElementsByClassName('numbers');
  for (var _i = 0; _i < $label.length; _i++) {
    labels.push($label[_i].textContent);
    scores.push(Number(toHalfNumber($score[_i].value)));
  }
  var data = [{
    label: labels[0],
    y: scores[0]
...
/******/ });
//# sourceMappingURL=index-c651f320f1af377228f2.js.map